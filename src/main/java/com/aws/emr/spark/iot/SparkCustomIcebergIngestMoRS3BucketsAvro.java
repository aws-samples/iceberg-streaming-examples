 ...
 * and delete files in <b>Avro</b> format into the {@code employee_avro_uncompacted} table.
 *
...
public class SparkCustomIcebergIngestMoRS3BucketsAvro {
  public static void main(String[] args)
    ...
    S3BucketsMoRJob.run(
        args, "SparkCustomIcebergIngestMoRS3BucketsAvro", "employee_avro_uncompacted", "avro");
  }
}
