...
/**
 * Simple single-query MERGE benchmark on <b>Amazon S3 Tables</b>, Iceberg format-version <b>2</b>
 * (positional deletes). Direct port of {@link SparkCustomIcebergIngestMoR} to S3 Tables: consume
 ...
 * source. Paired with {@link SparkS3TablesMergeV3} to compare v2 vs v3 under an identical workload.
 *
 ...
 */
public class SparkS3TablesMergeV2 {

  private static final Logger log = LogManager.getLogger(SparkS3TablesMergeV2.class);

  private static final String NS = "spjbench";
  private static final String TABLE = "employee_mor_v2";
  private static final String TOPIC = "protobuf-demo-topic-pure";
  private static final String KAFKA_GROUP = "s3tables-mor-v2";
  private static final String FORMAT_VERSION = "2";

  public static void main(String[] args) throws Exception {
    JobConfig cfg = JobConfig.fromArgs(args);
    SparkSession spark = cfg.buildSession("SparkS3TablesMergeV2");
