 ...
 * and delete files in <b>ORC</b> format into the {@code employee_orc_uncompacted} table.
 *
...
public class SparkCustomIcebergIngestMoRS3BucketsORC {
  public static void main(String[] args)
    ...
    S3BucketsMoRJob.run(
        args, "SparkCustomIcebergIngestMoRS3BucketsORC", "employee_orc_uncompacted", "orc");
  }
}
