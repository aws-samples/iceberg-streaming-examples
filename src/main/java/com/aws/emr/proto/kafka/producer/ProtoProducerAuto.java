 ...
 */
public class ProtoProducerAuto {

    private static final org.apache.logging.log4j.Logger log = LogManager.getLogger(ProtoProducerAuto.class);
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        ProtoProducerAuto producer = new ProtoProducerAuto();
    ...
    public EmployeeOuterClass.Employee createEmployeeRecord() {
        Timestamp ts;
        if(ProtoProducerAuto.lateEvent){
    ...
    public void startProducer() throws InterruptedException {
        String topic = "protobuf-demo-topic-pure-auto";
        ...
        try (KafkaProducer<String, byte[]> producer = new KafkaProducer<>(getProducerConfig())){
            ...
            while (true) {
                ...
                if(ProtoProducerAuto.duplicates){
